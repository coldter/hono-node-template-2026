...
// Capability-based filtering was removed alongside the tenant authorization
// hook. The operator perimeter has not yet shipped a capabilities source;
// nav items are rendered as-declared until that lands.
